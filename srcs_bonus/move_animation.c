...
void	aw_up(t_game *game, int loc)
{
	...
	game->player_p.x -= 1;
	image_render(game, &game->bg, "./img/wu/00.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE + ((SIZE / 4) * 3));
	image_render(game, &game->bg, "./img/floor.xpm",
		game->player_p.y * SIZE, loc * SIZE);
	usleep(150000);
	image_render(game, &game->bg, "./img/wu/01.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE + ((SIZE / 4) * 2));
	image_render(game, &game->bg, "./img/floor.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE + ((SIZE / 4) * 3));
	usleep(150000);
	image_render(game, &game->bg, "./img/wu/02.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE + (SIZE / 4));
	image_render(game, &game->bg, "./img/floor.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE + ((SIZE / 4)));
	usleep(150000);
...
void	aw_down(t_game *game)
{
	...
	image_render(game, &buffer, "./img/wd/00.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE - ((SIZE / 3) * 2));
	image_render(game, &buffer, "./img/floor.xpm",
		game->player_p.y * SIZE, loc * SIZE);
	usleep(150000);
	image_render(game, &buffer, "./img/wd/01.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE - ((SIZE / 3)));
	image_render(game, &buffer, "./img/floor.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE - ((SIZE / 3)));
	usleep(150000);
...
void	aw_left(t_game *game, int loc)
{
	...
	game->player_p.y -= 1;
	image_render(game, &game->bg, "./img/wl/00.xpm",
		game->player_p.y * SIZE + ((SIZE / 4) * 3), game->player_p.x * SIZE);
	image_render(game, &game->bg, "./img/floor.xpm",
		loc * SIZE, game->player_p.x * SIZE);
	usleep(150000);
	image_render(game, &game->bg, "./img/wl/01.xpm",
		game->player_p.y * SIZE + ((SIZE / 4) * 2), game->player_p.x * SIZE);
	image_render(game, &game->bg, "./img/floor.xpm",
		game->player_p.y * SIZE + ((SIZE / 4) * 3), game->player_p.x * SIZE);
	usleep(150000);
	image_render(game, &game->bg, "./img/wl/02.xpm",
		game->player_p.y * SIZE + (SIZE / 4), game->player_p.x * SIZE);
	image_render(game, &game->bg, "./img/floor.xpm",
		game->player_p.y * SIZE + ((SIZE / 4)), game->player_p.x * SIZE);
	usleep(150000);
	image_render(game, &game->bg, "./img/wl/03.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE);
	image_render(game, &game->bg, "./img/floor.xpm",
		loc * SIZE, game->player_p.x * SIZE);
	usleep(150000);
...
void	aw_right(t_game *game, int loc)
{
	image_render(game, &game->bg, "./img/floor.xpm",
		loc * SIZE, game->player_p.x * SIZE);
	game->player_p.y += 1;
	image_render(game, &game->bg, "./img/wr/00.xpm",
		game->player_p.y * SIZE - ((SIZE / 4) * 3), game->player_p.x * SIZE);
	image_render(game, &game->bg, "./img/floor.xpm",
		loc * SIZE, game->player_p.x * SIZE);
	usleep(150000);
	image_render(game, &game->bg, "./img/wr/01.xpm",
		game->player_p.y * SIZE - ((SIZE / 4) * 2), game->player_p.x * SIZE);
	image_render(game, &game->bg, "./img/floor.xpm",
		game->player_p.y * SIZE - ((SIZE / 4) * 3), game->player_p.x * SIZE);
	usleep(150000);
	image_render(game, &game->bg, "./img/wr/02.xpm",
		game->player_p.y * SIZE - (SIZE / 4), game->player_p.x * SIZE);
	image_render(game, &game->bg, "./img/floor.xpm",
		game->player_p.y * SIZE - ((SIZE / 4)), game->player_p.x * SIZE);
	usleep(150000);
	image_render(game, &game->bg, "./img/wr/03.xpm",
		game->player_p.y * SIZE, game->player_p.x * SIZE);
	image_render(game, &game->bg, "./img/floor.xpm",
		loc * SIZE, game->player_p.x * SIZE);
	usleep(150000);
